...
public class Panel_Control_Doctores extends javax.swing.JPanel{
    ...
    private void initComponents(){
        ...
        titulo.setText("Acciones Doctores");
        titulo.setBounds(300, 25, 300, 30);
        this.add(titulo);
        ...
        lbl_Nombres.setBounds(50, 100, 80, lbl_txt_Height);
        this.add(lbl_Nombres);
        
        txt_Nombres.setBounds(150, 100, 200, lbl_txt_Height);
        ...
        lbl_Apellidos.setBounds(50, 150, 80, lbl_txt_Height);
        this.add(lbl_Apellidos);
        
        txt_Apellidos.setBounds(150, 150, 200, lbl_txt_Height);
        ...
        lbl_Password.setBounds(50, 200, 80, lbl_txt_Height);
        this.add(lbl_Password);
        
        txt_Password.setBounds(150, 200, 200, lbl_txt_Height);
        ...
        lbl_Genero.setBounds(50, 250, 80, lbl_txt_Height);
        this.add(lbl_Genero);
        
        cmb_Genero.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Masculino", "Femenino" }));
        cmb_Genero.setBounds(150, 250, 200, lbl_txt_Height);
        this.add(cmb_Genero);
        ...
        lbl_Especialidad.setBounds(380, 100, 100, lbl_txt_Height);
        this.add(lbl_Especialidad);
        
        txt_Especialidad.setBounds(480, 100, 200, lbl_txt_Height);
        ...
        lbl_Telefono.setBounds(380, 150, 80, lbl_txt_Height);
        this.add(lbl_Telefono);
        
        txt_Telefono.setBounds(480, 150, 200, lbl_txt_Height);
        ...
        lbl_Edad.setBounds(380, 200, 80, lbl_txt_Height);
        this.add(lbl_Edad);
        
        txt_Edad.setBounds(480, 200, 200, lbl_txt_Height);
        this.add(txt_Edad);
        ...
        btn_Crear_Doctor.setBounds(50, 350, 150, 30);
